...
"
      ...
      describe 'with source_dir => puppet:///modules/mymodule/fail2ban_src' do
        ...
        it {
          is_expected.to contain_file('/etc/fail2ban').with(
      ...
      describe 'with jails_config => file' do
        ...
        it { is_expected.to compile.and_raise_error(%r{jails_config => file without content and with fail2ban_ensure => present}) }
      end
